...
function removeFlavorByName(originalFlavors){
    ...
    console.log(originalFlavors.splice[13])
        // should remove data nut
}
...
function copy(originalFlavors){
    ...
    set cloneArray = function(originalFlavors) {
...
function filterByWord(originalFlavors) {
    ...
    console.log(originalFlavors.includes(...originalFlavors[]))
